...
public class Main {
    ...
    {
        Vegetable cucumber = new Vegetable("бульба", 15,3);
        Vegetable onion = new Vegetable("часнок", 40,2);
        Vegetable cabbage = new Vegetable("маркоука",25 ,6);
        Vegetable carrot = new Vegetable("памидор", 41,12);
        Vegetable tomatoes = new Vegetable("агурок", 25,6);
