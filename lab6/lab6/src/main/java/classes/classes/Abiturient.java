...
public class Abiturient {
    ...
    public static Abiturient[] getArrAbit()
    {
        ...
        for (var i = 3 ; i >= 0; i--)
        {
            ...
            marks.add(i +2);
            marks.add(i + 3);
            abiturients[i] = new Abiturient(i,Integer.toString(i),Integer.toString(i),Integer.toString(i),Integer.toString(i),Integer.toString(i),marks);
        }
        return abiturients;
    }
