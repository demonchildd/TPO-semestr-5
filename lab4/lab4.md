...
<strong>Заголовок:</strong> Просмотр информации о товаре<br>
<strong>Предусловие:</strong> Пользователь захотел ознакомиться с товаром<br>
<strong>Шаги:</strong><br>
1. Перейти на сайт https://newton.by/
2. Посредствам поиска и/или панели "рекомендуем" найти необходимые товары
3. Выбрать необходимый товар
4. Открыть товар
5. Найти информацию про наличие товара, его стоимость, описание и т.д.

<strong>Ожидаемый результат:</strong> Найдена вся необходимая информация про товар<br>
<strong>Фактические результаты: </strong> Как ожидаемый<br>
<img height="400" src="Info.png" title="img with result" width="1300"/><br>
<strong>Статус: </strong> Пройден<br>
<hr>


<strong>Заголовок:</strong> Сравнение товаров<br>
<strong>Предусловие:</strong> Пользователю понравилось несколько товаров, не может определиться с выбором. Решил сравнить товары<br>
<strong>Шаги:</strong><br>
1. Перейти на сайт https://newton.by/
2. Посредствам поиска и/или панели "рекомендуем" найти необходимые товары
3. Выбрать понравившиеся товары (нажать на значок "Весы")
4. В правом верхнем углу нажать на значок "Весы"
5. Сравнить товары

<strong>Ожидаемый результат:</strong> Посмотреть характеристики всех товаров в удобном режиме<br>
<strong>Фактические результаты: </strong> Как ожидаемый<br>
<img height="500" src="Compare.png" title="img with result" width="500"/><br>
<strong>Статус: </strong> Пройден<br>
<hr>


<strong>Заголовок:</strong> Удаление товаров из корзины<br>
<strong>Предусловие:</strong> Пользователь захотел удалить товар из корзины<br>
<strong>Шаги:</strong><br>
1. Перейти на сайт https://newton.by/
2. Зайти в корзину
3. Найти товар который мы хотим убрать
4. Нажать на значок "Крестик"

<strong>Ожидаемый результат:</strong> Товар удалился из корзины<br>
<strong>Фактические результаты: </strong> Как ожидаемый<br>
<img height="500" src="Delete.png" title="img with result" width="1300"/><br>
<strong>Статус: </strong> Пройден<br>
<hr>